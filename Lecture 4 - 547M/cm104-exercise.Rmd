...
comm_fun <- function(s,t) {
  str_c(s, "takes", t, "minute to get to work")
}
...
map2(name, commute, function(t, s) str_c(s, "takes", t, "minute to get to work"))
...
map2(name, commute, ~ str_c(.x, "takes", .y, "minute to get to work"))
