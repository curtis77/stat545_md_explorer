...
ggplot(gap_asia_2007, aes(lifeExp, country)) + 
  geom_point()
```
...
gap_select %>%
  mutate(country = fct_reorder(country, year, lifeExp)) %>%
...
```
/master/notes/cm012-exercise.Rmd), or [from html](http://stat545.com/Classroom/notes/cm012-exercise.nb.html)